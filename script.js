const i18nStrings = {
    ...
    foundersSubtitle: {
        ...
        de: "Bei uns bekommen Sie keine Wundertüte, sondern erfahrene Profis, die sich Ihrem Erfolg widmen."
    },
    founder1Name: { en: "Lukas Henke", de: "Lukas Henke" },
    founder1Title: { en: "PERFORMANCE & TECH LEAD", de: "PERFORMANCE & TECH LEAD" },
    founder1Desc: {
        en: "Lukas is an expert in data-driven marketing focused on tracking, automation, and technical implementation. His focus is on strategic performance optimization – through precise data analyses, smart processes, and the seamless integration of all systems along the digital customer journey.",
        de: "Lukas ist Experte für datengetriebenes Marketing mit Fokus auf Tracking, Automatisierung und technische Umsetzung. Sein Fokus liegt auf strategischer Performance-Optimierung – durch präzise Datenanalysen, smarte Prozesse und die reibungslose Verzahnung aller Systeme entlang der digitalen Customer Journey."
    },
    founder2Name: { en: "Taylan Demirkol", de: "Taylan Demirkol" },
    founder2Title: { en: "E-COMMERCE & STRATEGY LEAD", de: "E-COMMERCE & STRATEGIE LEAD" },
    founder2Desc: {
    ...
    service2Text: {
        en: "We make your online shop more successful – with clear structure, seamless user guidance, and targeted conversion optimization. For more sales, loyal customers, and sustainable growth.",
        de: "Wir machen Ihren Onlineshop erfolgreicher – mit klarer Struktur, reibungsloser Nutzerführung und gezielter Conversion-Optimierung. Für mehr Verkäufe, treue Kund:innen und nachhaltiges Wachstum."
    },
